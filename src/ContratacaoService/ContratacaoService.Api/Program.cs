...
using Prometheus;
using ContratacaoService.Api.Mcp;
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new()
    {
        ...
        Version     = "v1",
        Description = "API para contratacao de propostas de seguro â€” Arquitetura Hexagonal"
    });
});
...
builder.Services.AddOpenTelemetry()
    .WithTracing(tracing => tracing
        .SetResourceBuilder(ResourceBuilder.CreateDefault().AddService("contratacao-api"))
...
builder.Services.AddMcpServer()
    .WithHttpTransport()
    .WithTools<ContratacaoMcpAdapter>();
...
var healthChecks = builder.Services.AddHealthChecks()
    .AddCheck("contratacao-api", () =>
        HealthCheckResult.Healthy("Contratacao de Seguros API â€” online"),
        tags: ["live"])
    .AddUrlGroup(
...
if (usarRabbitMQ)
{
    healthChecks.AddCheck("rabbitmq", () =>
        HealthCheckResult.Healthy("RabbitMQ â€” online"),
        tags: ["ready", "mq"]);
}
